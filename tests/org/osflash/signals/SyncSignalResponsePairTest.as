package org.osflash.signals
{
	...
	{	
		...
		{
			assertEqualsArrays('the main signal has the required value types, including the response Signal', [ISignalOwner, Sprite, String], responsePair.valueClasses);
		}
		...
		private function checkRequestDispatch(responseSignal:ISignalOwner, sprite:Sprite, str:String):void
		{
		...
		protected function respondToRequest(responseSignal:ISignalOwner, sprite:Sprite, str:String):void
		{
